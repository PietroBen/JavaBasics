...
public class Main {
    ...
    private static void exercise3() {
        // print the exercise 3
        System.out.println("\nExercise 3:");

        // define a boolean variable if has eaten lunch
        boolean hasEatenLunch = false;

        // define a double variable for lunch cost = 5.99
        double lunchCost = 5.99;

        // print the lunch cost and its value
        System.out.println("Lunch cost=" + lunchCost);
        // print the boolean value if he didn't eat lunch
